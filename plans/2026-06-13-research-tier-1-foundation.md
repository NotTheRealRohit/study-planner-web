...
- [`plans/2026-06-08-pillar-a-fastapi-backend.md`](2026-06-08-pillar-a-fastapi-backend.md) — format/discipline template (the TS→Python port that produced `py-progress`).
...
- [`plans/2026-06-08-pillar-a-fastapi-backend.md`](2026-06-08-pillar-a-fastapi-backend.md) — format/discipline template.
