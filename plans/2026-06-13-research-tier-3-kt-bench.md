...
**Author:** Claude + ***REMOVED***
**Plan status:** Draft
**Upstream:** [`handovers/2026-06-13-research-tier.md`](../handovers/2026-06-13-research-tier.md) · index: [`plans/2026-06-13-research-tier.md`](2026-06-13-research-tier.md)
...
- [`.cursor/rules/docker-colima-setup.mdc`](../.cursor/rules/docker-colima-setup.mdc) + [`.cursor/rules/pnpm-build-registry.mdc`](../.cursor/rules/pnpm-build-registry.mdc) — ***REMOVED*** / CA patterns **if torch or dataset pulls fail** on this machine.
...
| `research/kt-bench/README.md` | new | 4a | Two-step run instructions + ***REMOVED*** notes |
...
- Network access to fetch pyKT + datasets; if pulls fail, use the ***REMOVED*** / ***REMOVED*** pattern in [`docker-colima-setup.md`](../.cursor/rules/docker-colima-setup.mdc) and [`pnpm-build-registry.md`](../.cursor/rules/pnpm-build-registry.mdc).
...
2. **Create the isolated venv (P4.1)** — own `.venv`, NOT `uv sync`:
   ...
   ./.venv/bin/pip install -r requirements.txt   # if registry/TLS fails, see ***REMOVED*** rule
   ```

3. **`research/kt-bench/README.md` (P4.1):** document the two-step (`preprocess → train → predict`), the venv activation, the ***REMOVED*** fallback, and the **hard rule**: this env is never imported by the clean workspace; the seam is `research/results/kt/*.json`.
...
**Status:** ✅ Complete — ded302eb7920e308a79ead8c7d94591a61b17df1
**Depends on:** Phase 4b
...
- [`college/scope/research-decisions-and-findings.md`](../college/scope/research-decisions-and-findings.md) — decisions #15, #16.
- [`.cursor/rules/docker-colima-setup.mdc`](../.cursor/rules/docker-colima-setup.mdc), [`.cursor/rules/pnpm-build-registry.mdc`](../.cursor/rules/pnpm-build-registry.mdc) — ***REMOVED*** / ***REMOVED*** fallbacks for torch/dataset pulls.
