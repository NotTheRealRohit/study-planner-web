...
**Plan status:** Draft
**Upstream:** builds on [`plans/2026-06-20-enriched-shrink-production-integration/PLAN.md`](../2026-06-20-enriched-shrink-production-integration/PLAN.md) (server-side calibration shipped + Cowork-verified). Resolves its OQ-02 (offline/caching) and the dev-side of OQ-03 (auth/CORS). Production *hosting* remains deferred (apps are not deployed yet).
