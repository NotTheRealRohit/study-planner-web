...
- Prior FastAPI backend plan — `plans/2026-06-08-pillar-a-fastapi-backend.md`
...
sed -n '1,5p' plans/2026-06-20-enriched-shrink-production-integration/VERIFICATION.md  # Phase 0 GO/NO-GO recorded
```
