...
**Plan status:** Draft
**Upstream:** `issues/011-playlist-as-one-material.md`
...
- `issues/011-playlist-as-one-material.md` — issue with acceptance criteria
...
- `issues/011-playlist-as-one-material.md` — full issue with acceptance criteria
- `issues/012-slot-merge-drag-drop.md` — deferred follow-up issue
