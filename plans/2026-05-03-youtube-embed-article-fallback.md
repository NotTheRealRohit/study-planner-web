...
**Plan status:** Draft
**Upstream:** `issues/007-active-session-with-youtube-embed.md` · `prd/PRD-study-tracker-web.md`
...
- Issue: `issues/007-active-session-with-youtube-embed.md`
- PRD: `prd/PRD-study-tracker-web.md` (user stories 17–20, 22–23)
- Design reference (desktop YouTube): `issues/images/expectedDesign/image.png`
- Design reference (mobile YouTube): `issues/images/expectedDesign/image copy.png`
...
**Owner / resolution path:** ***REMOVED*** updates the PRD manually.
**Cross-ref:** D-05
...
- Issue #007: `issues/007-active-session-with-youtube-embed.md`
- PRD: `prd/PRD-study-tracker-web.md`
- YouTube IFrame Player API: https://developers.google.com/youtube/iframe_api_reference
- Design mockup (desktop YouTube): `issues/images/expectedDesign/image.png`
- Design mockup (mobile YouTube): `issues/images/expectedDesign/image copy.png`
