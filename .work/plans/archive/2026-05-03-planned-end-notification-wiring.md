...
**Plan status:** Draft
**Upstream:** `../../specs/issues/008-planned-end-ping-notification-strategy.md` · `../../specs/prd/PRD-study-tracker-web.md` (user stories 22, 23)
...
- Issue: `../../specs/issues/008-planned-end-ping-notification-strategy.md`
- PRD: `../../specs/prd/PRD-study-tracker-web.md` (user stories 22, 23)
- Existing plan for session per-kind rendering: `2026-05-03-youtube-embed-article-fallback.md`
...
- Issue #008: `../../specs/issues/008-planned-end-ping-notification-strategy.md`
- PRD: `../../specs/prd/PRD-study-tracker-web.md` — user stories 22, 23
...
- Prior plan (session per-kind rendering): `2026-05-03-youtube-embed-article-fallback.md`
