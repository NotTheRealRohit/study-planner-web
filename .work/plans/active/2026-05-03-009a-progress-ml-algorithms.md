...
**Plan status:** Draft
**Upstream:** `../../specs/issues/009-progress-engine-and-pace-calibration.md`, `../../specs/prd/PRD-study-tracker-web.md`
...
- Issue: `../../specs/issues/009-progress-engine-and-pace-calibration.md`
- PRD: `../../specs/prd/PRD-study-tracker-web.md` (user stories 14, 15; module decomposition)
- Downstream issues: `../../specs/issues/010-replan-flow-with-three-options.md` (consumes projections), `../../specs/issues/011-weekly-progress-streaming-narrative.md` (consumes verdict + weekly stats)
- Hyperparameter sweep results: `../../specs/issues/images/cusum_sweep.png`, `kalman_sweep.png`, `gp_sweep.png`
...
1. **Create `packages/progress/src/bayesian.ts`:** Hierarchical Normal-Normal conjugate update model. Implements D-04.
   ...
   Reference implementation: `../../specs/issues/images/hyperparam_sweep.py` lines that implement the Bayesian model.
...
2. **Create `packages/progress/src/cusum.ts`:** CUSUM detector. Implements D-05, D-10.
   ...
   Reference: `../../specs/issues/images/hyperparam_sweep.py` CUSUM implementation.
...
1. **Create `packages/progress/src/gp.ts`:** Gaussian Process with Linear + RBF kernel. Implements D-07.
   ...
   Reference: `../../specs/issues/images/hyperparam_sweep.py` GP implementation (with detrending).
...
- Issue #009: `../../specs/issues/009-progress-engine-and-pace-calibration.md`
- PRD: `../../specs/prd/PRD-study-tracker-web.md`
- Python reference implementation: `../../specs/issues/images/hyperparam_sweep.py`
- Hyperparameter sweep results: `../../specs/issues/images/cusum_sweep.png`, `kalman_sweep.png`, `gp_sweep.png`
- Best-params visualizations: `issues/images/best_params_*.png`
