# Handoff --- Progress Lab pace indicators -啋 Codex

**Date:** 2026-07-19 路 **From:** Cowork (planning/review) 路 **To:** Codex (gpt-5.5), Sonnet secondary
**Plan:** [`PLAN.md`](./PLAN.md) 路 **Log:** [`VERIFICATION.md`](./VERIFICATION.md)

## What this is

Rework the Week -啋 Progress Lab modal so it presents **three dated finishes** (Plan deadline 路
GP forecast 路 Pace scenario), turns the plot fully interactive (coordinate crosshair), and gives
...
3. Work `PLAN.md` phases 1-啋4 in order; fill `VERIFICATION.md` after each; expect review before moving on.
...
All four phases `-渽 Verified` in `VERIFICATION.md`; `capacityScenario.ts` + `Replan.tsx` diffs
