...
**Prerequisite plan:** Plan A (`2026-05-03-009a-progress-ml-algorithms.md`) — must be complete before Phase 2+.
...
- Burn-up design: `../../specs/issues/images/expectedDesign/burnupchart.png`
